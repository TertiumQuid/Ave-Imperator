...
{
    [Serializable()]
    public class Armor : BusinessBase<Armor>
    {
        ...
        public ManeuverList Maneuvers
        {
            ...
            get
            {
                if ( _maneuvers == null )
                {
                    _maneuvers = ManeuverList.GetArmorManeuverList( _id );
                }
        ...
        internal Armor( int id, int damage, int itemConditionId, string name, string description, string itemCondition )
        {
            _id = id;
            _damage = damage;
