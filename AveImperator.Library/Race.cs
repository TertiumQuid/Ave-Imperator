...
{
    [Serializable()]
    public class Race : BusinessBase<Race>
    {
        ...
        {
            return DataPortal.Fetch<Race>( new Criteria( id ) );
        }

        public override Race Save()
        {
            return base.Save();
        }
        ...
        internal Race( int id, int constitution, int cunning, int endurance, int strength, string name, string description )
        {
            _id = id;
